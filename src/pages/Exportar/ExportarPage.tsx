...
import type { ExportTextFormat } from "../../services/export.service";
...
export default function ExportarPage() {
  ...
  const [formato, setFormato] = useState<ExportTextFormat>("compras");
  ...
  const tabS = (id: ExportTextFormat): CSSProperties => ({ flex:1, padding:"9px 6px", borderRadius:9, border:"none", cursor:"pointer",
