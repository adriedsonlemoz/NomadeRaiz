...
export function EquipmentCard({ item }) {
  ...
  const handleToggle = (e) => {
    ...
    toggle(item.id);
    if (tornando) { success(); setFlash(true); setTimeout(()=>setFlash(false),500); }
  };
  ...
  return (
    <>
      ...
      {/* Card compacto — altura reduzida, sem área expansível */}
      <div
        ...
        {/* Checkbox — intercepta clique sem abrir modal */}
        <button
